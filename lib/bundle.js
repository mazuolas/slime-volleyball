...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__easy_computer_js__ = __webpack_require__(7);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const clearStart = (game, difficulty) => () => {
  ...
  onePlayer.addEventListener('click', clearStart(game.onePlayerGame, difficulty));
